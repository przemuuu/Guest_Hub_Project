...
import axiosInstanceForPhotoUploading from "../src/axiosInstanceForPhotoUploading";
...
export default function PhotosUploader({addedPhotos,onChange}) {
  ...
  async function addPhotoByLink(ev) {
    ev.preventDefault();
    const {data:filename} = await axiosInstanceForPhotoUploading.post('/upload-by-link', {link: photoLink});
    onChange(prev => {
  ...
  function uploadPhoto(ev) {
    ...
    axiosInstanceForPhotoUploading.post('/upload', data, {
